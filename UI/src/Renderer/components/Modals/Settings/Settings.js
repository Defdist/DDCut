...
import {
    ...
    FormControlLabel, Checkbox, TextField, Tooltip
...
function Settings(props) {
    ...
    const [defaultTimeout, setDefaultTimeout] = React.useState(0);
    ...
    function handleSave() {
        ipcRenderer.send("Settings::UpdateSettings", pause, defaultTimeout, enableSlider, maxFeedRate);
        setOpen(false);
    }
                    ...
                    <FormControlLabel
                        control={
                            <TextField
                                ...
                                onChange={e => setDefaultTimeout(e.currentTarget.valueAsNumber)}
                            />
                        }
